...
--GO
INSERT INTO dbo.animalshelter (animalshelterid, AnimalsName, Species, PrimaryBreed)
VALUES 
    ('2017-05-10', 'Toby', 'Dog', 'Bulldog', 'Mix'),
    ('2017-09-30', 'Luna', 'Cat', 'Ragdoll', 'Mix'),
    ('2018-12-18', 'Coco', 'Dog', 'Shih Tzu', NULL),
    ('2019-06-21', 'Rocky', 'Dog', 'Boxer', 'Mix'),
    ('2020-05-17', 'Molly', 'Cat', 'Persian', 'Mix'),
    ('2021-11-11', 'Chloe', 'Cat', 'British Shorthair', NULL),
    ('2022-07-22', 'Bailey', 'Dog', 'Dachshund', 'Mix'),
    ('2022-10-19', 'Stella', 'Cat', 'Maine Coon', 'Mix'),
    ('2023-01-07', 'Ruby', 'Dog', 'Cocker Spaniel', NULL),
    ('2023-03-15', 'Loki', 'Cat', 'Russian Blue', 'Mix'),
    ('2016-02-11', 'Shadow', 'Dog', 'Rottweiler', 'Mix'),
    ('2017-04-16', 'Buddy', 'Dog', 'Pit Bull', NULL),
    ('2018-08-25', 'Nala', 'Cat', 'Abyssinian', 'Mix'),
    ('2019-03-14', 'Finn', 'Dog', 'Basset Hound', 'Mix'),
    ('2020-06-18', 'Gizmo', 'Cat', 'Sphynx', 'Mix'),
    ('2021-01-25', 'Jasper', 'Dog', 'Samoyed', NULL),
    ('2021-09-30', 'Lilly', 'Cat', 'Savannah', 'Mix'),
    ('2022-12-13', 'Riley', 'Dog', 'Mastiff', 'Mix'),
    ('2023-05-24', 'Zeus', 'Dog', 'Doberman Pinscher', NULL),
    ('2016-07-15', 'Simba', 'Cat', 'Egyptian Mau', 'Mix'),
    ('2017-11-22', 'Sophie', 'Dog', 'Great Dane', 'Mix'),
    ('2018-04-11', 'Henry', 'Dog', 'Chihuahua', NULL),
    ('2019-10-06', 'Oscar', 'Cat', 'Chartreux', 'Mix'),
    ('2020-11-03', 'Murphy', 'Dog', 'Bernese Mountain Dog', 'Mix'),
    ('2021-08-19', 'Roxy', 'Cat', 'American Shorthair', 'Mix'),
    ('2022-04-27', 'Benny', 'Dog', 'Vizsla', NULL),
    ('2023-06-30', 'Willow', 'Cat', 'Turkish Angora', 'Mix'),
    ('2023-07-12', 'Duke', 'Dog', 'Newfoundland', 'Mix'),
    ('2016-09-21', 'Lulu', 'Cat', 'Selkirk Rex', 'Mix'),
    ('2017-03-28', 'Jake', 'Dog', 'Weimaraner', NULL),
    ('2018-10-19', 'Ollie', 'Cat', 'Japanese Bobtail', 'Mix'),
    ('2019-07-05', 'Sadie', 'Dog', 'Akita', 'Mix'),
    ('2020-02-29', 'Piper', 'Cat', 'Snowshoe', 'Mix'),
    ('2021-12-21', 'Hazel', 'Dog', 'Irish Setter', NULL),
    ('2022-11-18', 'Pepper', 'Cat', 'Singapura', 'Mix'),
    ('2023-08-14', 'Ace', 'Dog', 'Portuguese Water Dog', 'Mix'),
    ('2023-09-29', 'Buster', 'Cat', 'Manx', 'Mix'),
    ('2022-05-25', 'Baku', 'Cat', 'Mix', 'Mix');
GO
...
BEGIN
    BEGIN TRY
        ...
        IF NOT EXISTS (SELECT 1 FROM dbo.stagingTable WHERE [License Number] = @p_location_id)
        BEGIN
            SET @p_message = 'location_id does not exist.';
            ROLLBACK;
            RETURN;
        END

        -- Insert data
        INSERT INTO dbo.db_animal_shelter (shelter_id, customer_id, dogs_id, cats_id, volunteers_id, location_id)
        VALUES (@p_shelter_id, @p_customer_id, @p_dogs_id, @p_cats_id, @p_volunteers_id, @p_location_id);
